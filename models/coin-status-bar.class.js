class CoinStatusBar extends DrawableObject {
  ...
  /**
   * Updates exact coin stock values for label rendering.
   * @param {number} currentStock - Current coin amount.
   * @param {number} maxStock - Maximum coin amount.
   */
  ...
  /**
   * Draws coin bar plus exact stock label.
  ...
  /**
   * Draws centered counter text on the coin bar.
   * @param {CanvasRenderingContext2D} context - Canvas render context.
   */
  drawCounter(context) {
